...
BtnConfirm.MouseButton1Click:Connect(function()
    if PassInput.Text == CorrectPassword then
        ...
        TweenService:Create(LoginFrame, TweenInfo.new(0.5), {
        ...
        TweenService:Create(LoginFrame, TweenInfo.new(0.1), {Position = UDim2.new(0.5,-180,0.5,-210)}):Play()
        wait(0.1)
        TweenService:Create(LoginFrame, TweenInfo.new(0.1), {Position = UDim2.new(0.5,-200,0.5,-210)}):Play()
        wait(0.1)
...
function CargarMenuPrincipal()
    ...
    AddButton(1, "💥 AUTO PUNCH", Color3.fromRGB(150,0,0), function() _G.AutoPunch = not _G.AutoPunch end)
    AddButton(1, "🔋 SIN COOLDOWN", Color3.fromRGB(0,100,150), function() _G.NoCooldown = not _G.NoCooldown end)
    AddButton(1, "🛡️ MODO DIOS", Color3.fromRGB(200,150,0), function() _G.GodMode = not _G.GodMode end)
end
